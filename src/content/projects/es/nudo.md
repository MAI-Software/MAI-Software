...
Se arrastra la cuerda con el ratón y cada tramo sigue al anterior como lo haría un cable de verdad. La clave está en los cruces: con **clic derecho o Shift** el tramo que mueves pasa **por debajo** en lugar de por encima, que es lo que permite deshacer lazos que de otro modo se apretarían más.

Mientras se juega, la pantalla muestra solo lo necesario: un medidor de **integridad** del cable, los **puntos** y el **tiempo**. Cada nivel parte de un objeto cotidiano — el primero, unos auriculares.

## Estado

En desarrollo y jugable en el navegador, sin instalar nada.
